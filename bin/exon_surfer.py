...
def main(): 
    ...
    gene, transcripts, path_out, species = args.gene, args.transcript, args.path_out, args.species
    CreatePrimers(gene = gene, transcripts = transcripts, species = species, path_out = path_out)
